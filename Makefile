...
OBJ_DEBUG = $(OBJDIR_DEBUG)/src/Help.o $(OBJDIR_DEBUG)/src/main.o $(OBJDIR_DEBUG)/src/Show.o $(OBJDIR_DEBUG)/src/Report.o $(OBJDIR_DEBUG)/src/Observer.o $(OBJDIR_DEBUG)/src/Learn.o $(OBJDIR_DEBUG)/src/Janitor.o $(OBJDIR_DEBUG)/src/Bot.o $(OBJDIR_DEBUG)/src/Forget.o $(OBJDIR_DEBUG)/src/Execute.o $(OBJDIR_DEBUG)/src/ConfigParser.o $(OBJDIR_DEBUG)/src/Commands.o $(OBJDIR_DEBUG)/src/CommandHandler.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/src/Help.o $(OBJDIR_RELEASE)/src/main.o $(OBJDIR_RELEASE)/src/Show.o $(OBJDIR_RELEASE)/src/Report.o $(OBJDIR_RELEASE)/src/Observer.o $(OBJDIR_RELEASE)/src/Learn.o $(OBJDIR_RELEASE)/src/Janitor.o $(OBJDIR_RELEASE)/src/Bot.o $(OBJDIR_RELEASE)/src/Forget.o $(OBJDIR_RELEASE)/src/Execute.o $(OBJDIR_RELEASE)/src/ConfigParser.o $(OBJDIR_RELEASE)/src/Commands.o $(OBJDIR_RELEASE)/src/CommandHandler.o
...
$(OBJDIR_DEBUG)/src/ConfigParser.o: src/ConfigParser.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c src/ConfigParser.cpp -o $(OBJDIR_DEBUG)/src/ConfigParser.o
...
$(OBJDIR_RELEASE)/src/ConfigParser.o: src/ConfigParser.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c src/ConfigParser.cpp -o $(OBJDIR_RELEASE)/src/ConfigParser.o
